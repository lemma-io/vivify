...
/**
 * Offset-based paging object is a container for a set ALBUM objects.
 * Contains a key called items whose value is an array
 * of the requested ALBUM objects
 */
@Parcel
public class AlbumPager {

    public String href;         // Link to Web API returning full request response
    public List<Album> items;   // The requested data, Tracks in this case
